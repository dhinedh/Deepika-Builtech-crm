...
async function broadcastAllMessages() {
  console.log('🚀 Resending Lead Notifications & Sales Messages to updated 5 target numbers:\n');
  console.log(NOTIFICATION_NUMBERS.map(n => `+${n}`).join(', '));
  console.log('\n========================================\n');
  ...
  console.log('🎉 Broadcast completed successfully to all 5 target sales numbers!');
  process.exit(0);
}
