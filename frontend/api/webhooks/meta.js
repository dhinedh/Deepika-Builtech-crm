...
// ✅ Standalone Initialization — Uses Vercel Environment Variables
...
export default async function handler(req, res) {
  ...
  // ✅ Handle POST — WhatsApp Message Receiver
  if (req.method === 'POST') {
    try {
      const body = req.body;
      ...
      if (changes?.messages) {
        ...
        // Check for duplicate Leads/Contacts
